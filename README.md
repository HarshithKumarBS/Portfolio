# Harshith Kumar B S — Portfolio

Premium personal portfolio website built with Vite + React.
...
- **Personal info**: Update links, email, and descriptions in each component under `src/components/`
